...
const Discover = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Machine learning powered code completion and suggestion engine",
      category: "ai/ml",
    ...
    },
    {
      ...
      description: "Cross-platform messaging app built with React Native and Firebase",
      category: "mobile",
    ...
    },
    {
      ...
      description: "Collection of scripts and tools for CI/CD pipeline automation",
      category: "backend",
  ...
  const handleSwipeComplete = (direction) => {
    ...
    cardRef.current.style.transform = `translate(${finalX}px, ${dragOffset.y}px) rotate(${direction === 'right' ? 45 : -45}deg)`;
  ...
  return (
    <div className="container-fluid bg-light min-vh-100 mt-5">
      <div className="row">
        ...
        <div className="col-lg-3 col-md-4 border-end bg-white sidebar-wrapper">
          <div className="p-4 sticky-top">
            ...
            <div className="mb-4">
              ...
              <div className="d-flex flex-column gap-2">
                {["All", "Frontend", "Backend", "Full Stack", "Mobile", "AI/ML"].map(
                  (category) => (
                    <button
                      key={category}
