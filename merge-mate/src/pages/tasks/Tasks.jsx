      ...
      <div className="row">
        <div className="col-lg-3 col-md-4 border-end bg-gradient sidebar-wrapper">
          ...
          <div className="p-4 sticky-top">
            <div className="filter-card p-3 mb-4 rounded-3 bg-white shadow-sm">
          ...
          <div className="p-4">
            ...
            <div className="row g-4">
              {filteredTasks.map((task) => (
                <div key={task.id} className="col-xl-4 col-md-6">
                  <div className="task-card bg-white p-4 rounded-3 shadow-sm hover-card">
